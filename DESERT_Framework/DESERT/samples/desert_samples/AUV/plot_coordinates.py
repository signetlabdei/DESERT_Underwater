...
X_e_s = []
Y_e_s = []
file_path = 'error_log_a.csv'  # Replace with your file pathplot_coordinates(file_path)
plot_movement_log(file_path,X_e_s,Y_e_s)
...
ax.plot(X_e_c, Y_e_c, 'b^',label='error_called')
ax.plot(X_e_s, Y_e_s, 'bx',label='error_solved')
ax.plot(X_e, Y_e, 'rx',label='error_Solved')
ax.legend()
plt.show()
