...
$db_ssp setDbPathName "${opt(db_path)}/ssp/WOA2018_SSP_April.nc"
...
WOSS/Module/MPhy/BPSK  set MaxTxSPL_dB_               156
WOSS/Module/MPhy/BPSK  set MinTxSPL_dB_               10
WOSS/Module/MPhy/BPSK  set MaxTxRange_                1000
WOSS/Module/MPhy/BPSK  set PER_target_                0
WOSS/Module/MPhy/BPSK  set RxSnrPenalty_dB_           0
WOSS/Module/MPhy/BPSK  set TxSPLMargin_dB_            0
...
proc createSINK { } {
	...
	set interf_sink [new "MInterference/MIV"]
  	$interf_sink set maxinterval_ $opt(maxinterval_)

    $phy_data_sink setSpectralMask     $data_mask
    $phy_data_sink setPropagation      $propagation
	$phy_data_sink setInterference    $interf_sink
  	#### we set the transducer labeled "ITC-3001" for SPL, input power and energy consumpion computations
  	$phy_data_sink setTransducerType  [expr [$data_mask getFreq] - [$data_mask getBandwidth] / 2.0 ] [expr [$data_mask getFreq] + [$data_mask getBandwidth] / 2.0 ] "ITC-3001"
