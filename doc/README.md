...
DESERT is based on a fork of ns2 [2] ([ns-2.34-sa](https://github.com/signetlabdei/ns2-uwsignet)) and NS-Miracle [3] ([NS-Miracle-2](https://github.com/signetlabdei/nsmiracle)). In particular, DESERT follows the modular approach of the latter. Other than network protocols, DESERT provides additional libraries and tools to help simulate underwater networks realistically. These tools include mobility models that reproduce realistic mobility patterns, energy consumption models, and channel models.
